    ...
    <div className="p-4 dark:text-white">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-8">
        <div className="bg-blue-100 dark:bg-blue-800 p-6 rounded-lg shadow-md">
          ...
          <p className="text-4xl font-bold text-blue-600 dark:text-blue-300">{userCount}</p>
        ...
        <div className="bg-green-100 dark:bg-green-800 p-6 rounded-lg shadow-md">
          ...
          <Link href="/comment" className="text-green-500 hover:underline mt-2 inline-block">
            ดูความคิดเห็นทั้งหมด
          </Link>
        </div>

        <div className="bg-yellow-100 dark:bg-yellow-800 p-6 rounded-lg shadow-md">
          <h2 className="text-xl font-semibold mb-2 text-yellow-800 dark:text-yellow-200">จำนวนการแจ้งเตือน</h2>
          <p className="text-4xl font-bold text-yellow-600 dark:text-yellow-300">{notificationCount}</p>
          <Link href="/notifications" className="text-yellow-500 hover:underline mt-2 inline-block">
      ...
      <nav>
        <ul className="space-y-2">
          ...
          <li>
            <Link href="/notifications" className="text-yellow-500 hover:underline">
              การแจ้งเตือน
            </Link>
          </li>
        </ul>
